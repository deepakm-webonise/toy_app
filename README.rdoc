...
3) Add the database.yml in *config/* directory. For sample database.yml
   kindly refer [this](https://gist.github.com/erichurst/961978) link

4) Update cron file

   Add a raketask in crontab
